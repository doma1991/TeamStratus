    ...
    async getTopFiveWeather( value ,latitude, longitude , value2){
        ...
        try {
            ...
            data = await response.json().then(responseJson =>{
                ...
                if(skycons.responseJson.currently.icon("clear-night") === 'clear-night') {
                    this.setState({[value]: Skycons.CLEAR_NIGHT });
                } else if(skycons.responseJson.currently.icon("clear-day") === 'clear-day') {
                    this.setState({[value]: Skycons.CLEAR_DAY });
                } else if(skycons.responseJson.currently.icon("partly-cloudy-day") === 'partly-cloudy-day') {
